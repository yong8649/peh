...
//#define POLARGRAPH
  ...
  #define POLARGRAPH_MAX_BELT_LEN  358.0 // (mm) Belt length at full extension. Override with M665 H.
...
//#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 87.5    // (mm)

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       87.5    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 175        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 25             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 87.5              // (mm) Get this value from G33 auto calibrate
